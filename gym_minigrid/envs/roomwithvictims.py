...
class RoomWithVictims(MiniGridEnv):
    ...
    def __init__(
        ...
        self.sideway_length = sideway_length

    def _gen_grid(self, width, height, sideway_length=2):
...
class Hall19x15seerescue2(HallwayWithVictims):
...
class Hall31x25seerescue10(HallwayWithVictims):
    def __init__(self, seed=None):
        super().__init__(
            width=31,
            height=25, 
...
class Hall15x15noseerescue2(HallwayWithVictims):
    def __init__(self, seed=None):
        super().__init__(
            width=15,
            height=15, 
...
# Doesn;t learn yet!!!
class Hall31x25noseerescue10(HallwayWithVictims):
    def __init__(self, seed=None):
        super().__init__(
            width=31,
            height=25, 
...
register(
    id='MiniGrid-Hall19x15seerescue2-v0',
    entry_point='gym_minigrid.envs:Hall19x15seerescue2'
)

register(
    id='MiniGrid-Hall31x25seerescue10-v0',
    entry_point='gym_minigrid.envs:Hall31x25seerescue10'
)

register(
    id='MiniGrid-Hall15x15noseerescue2-v0',
    entry_point='gym_minigrid.envs:Hall15x15noseerescue2'
)

# Doesn;t learn yet!!!
register(
    id='MiniGrid-Hall31x25noseerescue10-v0',
    entry_point='gym_minigrid.envs:Hall31x25noseerescue10'
)
